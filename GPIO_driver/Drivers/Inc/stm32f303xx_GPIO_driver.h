 ...
 */
#define GPIO_MODE_IN				0		// document defined
#define GPIO_MODE_OUT				1		// document defined
#define GPIO_MODE_ALTFN				2		// document defined
#define GPIO_MODE_ANALOG			3		// document defined
...
#define GPIO_OP_TYPE_OD				1		// open drained
